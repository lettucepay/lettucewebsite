      ...
      <div class="container marketing">
        ...
        <div class="row">
          ...
          <div class="col-lg-2">
           ...
           <i class="fa fa-home" aria-hidden="true" style="font-size: 18px;"></i>
            ...
            <div class="col-lg-2">
           <i class="fa fa-gamepad" aria-hidden="true" style="font-size: 18px;"></i>
            <p class="cat">Gaming</p>
           </div>
          ...
          <div class="col-lg-2">
           <i class="fa fa-car" aria-hidden="true" style="font-size: 18px;"></i>
            <p class="cat">Mobility</p>
           </div>

             <div class="col-lg-2">
            <i class="fa fa-mobile" aria-hidden="true" style="font-size: 19px;"></i>
        ...
        <div class="slide-container swiper">
            ...
            <div class="slide-content">
              <h4 class="mystore">Partner stores</h4>
